            ...
            <div className="max-w-7xl mx-auto py-6 sm:py-8 px-4 sm:px-6 lg:px-8">
                <div className="text-center">
                    <div className="flex items-center justify-center space-x-3 sm:space-x-4 mb-3 sm:mb-4">
                        ...
                        <h3 className={`${textUtils.title.card} bg-gradient-to-r from-teal-600 to-blue-600 bg-clip-text text-transparent`}>
                            Biomagnetismo Kids
                        </h3>
                    </div>
                    <p className={`${textUtils.body.small} mb-2`}>
                        &copy; {new Date().getFullYear()} Biomagnetismo Kids. Módulo Completado.
                    </p>
                    <p className={`${textUtils.body.small} text-slate-500 mb-3 sm:mb-4`}>
                    ...
                    <div className={`flex flex-wrap items-center justify-center gap-3 sm:gap-6 ${textUtils.body.small} text-slate-400`}>
                    ...
                    <div className="mt-4 pt-4 border-t border-slate-200/30">
                        <p className={`text-teal-600 font-medium ${textUtils.body.small}`}><strong>Método creado por:</strong> Dr. Miguel Ojeda Rios</p>
                        <p className={`text-slate-500 ${textUtils.body.small} mt-1`}>Instituto Centrobioenergética</p>
                        <p className={`text-slate-500 ${textUtils.body.small}`}>www.institutocentrobioenergetica.com</p>
                    </div>
