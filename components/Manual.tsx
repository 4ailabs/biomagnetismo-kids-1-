    ...
    return (
        <>
            ...
            <div className="bg-white/90 backdrop-blur-sm rounded-2xl shadow-xl border border-white/20 p-8 sm:p-10 space-y-10">
                ...
                {/* Lista de Pares Biomagnéticos - Acceso Directo */}
                <div className="mt-8 p-6 bg-gradient-to-r from-teal-50 to-blue-50 rounded-xl border border-teal-200 shadow-lg">
                    <div className="text-center">
                        <h4 className="text-lg font-semibold text-teal-700 mb-3">
                            📋 {t('header.paresList')}
                        </h4>
                        <p className="text-sm text-slate-600 mb-4">
                            {t('paresList.description')}
                        </p>
                        <button
                            onClick={() => window.open('/resources/lista-pares-biomagneticos.html', '_blank')}
                            className="inline-flex items-center px-6 py-3 bg-gradient-to-r from-teal-500 to-blue-500 text-white rounded-lg hover:from-teal-600 hover:to-blue-600 transition-all duration-300 shadow-md hover:shadow-lg transform hover:scale-105 font-medium"
                        >
                            <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5H7a2 2 0 00-2 2v10a2 2 0 002 2h8a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01" />
                            </svg>
                            {t('paresList.buttonText')}
                        </button>
                    </div>
                </div>
            </div>
