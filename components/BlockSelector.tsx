...
const BlockSelector: React.FC = () => {
  ...
  const getModuleBlocks = () => {
    if (activeModule === 1) {
      ...
      return [
        { id: 1, title: "Fundamentos", subtitle: "8 Conflictos Biológicos", icon: <BookOpen className="w-4 h-4 sm:w-5 sm:h-5 lg:w-6 lg:h-6" />, color: 'from-blue-400 to-indigo-500' },
        ...
        { id: 3, title: "Rastreo", subtitle: "Biomagnético Escolar", icon: <Search className="w-4 h-4 sm:w-5 sm:h-5 lg:w-6 lg:h-6" />, color: 'from-green-400 to-emerald-500' },
        { id: 4, title: "Sensaciones", subtitle: "18 Sensaciones Escolares", icon: <Brain className="w-4 h-4 sm:w-5 sm:h-5 lg:w-6 lg:h-6" />, color: 'from-purple-400 to-violet-500' },
        { id: 5, title: "Supervivencia", subtitle: "Estrategias y Patrones", icon: <Target className="w-4 h-4 sm:w-5 sm:h-5 lg:w-6 lg:h-6" />, color: 'from-orange-400 to-amber-500' },
